                ...
                <ul class="navbar-nav ml-auto navbar-list">
                                ...
                                <div class="iq-card-body p-0">
                                        ...
                                        <div class="media align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded"
                                                    src="https://iqonic.design/themes/streamitnew/dashboard/html/assets/images/user/01.jpg"
                                                    alt="">
                                            </div>
                                    ...
                                    <a href="index.html#" class="iq-sub-card">
                                        <div class="media align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded"
                                                    src="https://iqonic.design/themes/streamitnew/dashboard/html/assets/images/user/02.jpg"
                                                    alt="">
                                            </div>
                                            <div class="media-body ml-3">
                                    ...
                                    <a href="index.html#" class="iq-sub-card">
                                        <div class="media align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded"
                                                    src="https://iqonic.design/themes/streamitnew/dashboard/html/assets/images/user/03.jpg"
                                                    alt="">
                                            </div>
                                            <div class="media-body ml-3">
                                    ...
                                    <a href="index.html#" class="iq-sub-card">
                                        <div class="media align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded"
                                                    src="https://iqonic.design/themes/streamitnew/dashboard/html/assets/images/user/04.jpg"
                                                    alt="">
                                            </div>
                                            <div class="media-body ml-3">
                                ...
                                <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="index.html#" class="iq-sub-card">
                                        <div class="media align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded"
                                                    src="https://iqonic.design/themes/streamitnew/dashboard/html/assets/images/user/05.jpg"
                                                    alt="">
                                            </div>
                                            <div class="media-body ml-3">
                    ...
                    <li class="line-height pt-3">
                        <a href="index.html#" class="search-toggle iq-waves-effect d-flex align-items-center">
                            <img src="https://iqonic.design/themes/streamitnew/dashboard/html/assets/images/user/1.jpg"
