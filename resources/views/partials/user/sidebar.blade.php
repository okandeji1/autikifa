    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="active active-menu"><a href="/admin/user-dashboard" class="iq-waves-effect"><i
                            class="las la-home iq-arrow-left"></i><span>Dashboard</span></a></li>
                <li>
                    <a href="/admin/user-posts" class="iq-waves-effect collapsed"><i
                            class="las la-film"></i><span>Post</span><i
