                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse animate-box" data-animate-effect="fadeInUp"
                                ...
                                <ul class="navbar-nav ml-auto py-4 py-md-0">
                                    <li class="nav-item pl-md-0 ml-0 ml-md-4 active"> <a class="nav-link"
                                            href="/">HOME</a></li>
                                    <li class="nav-item pl-md-0 ml-0 ml-md-4"> <a class="nav-link dropdown-toggle"
                                            data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                                            aria-expanded="false">MUSIC <span class="fa fa-angle-down"></span></a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#">Audio Mack</a>
